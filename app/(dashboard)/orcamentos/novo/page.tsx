...
import { NovoOrcamentoContent } from './content'
...
async function NovoOrcamentoContent({ searchParams }: { searchParams: Promise<{ deal_id?: string }> }) {
  ...
  // Se tiver deal_id, buscar o contato associado ao deal
  ...
  return (
    <div className="space-y-6">
      ...
      <FormOrcamento
        ...
        contatoId={contatoSelecionado?.id || undefined}
      />
    </div>
  )
}
